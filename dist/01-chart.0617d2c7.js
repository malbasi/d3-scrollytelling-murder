...
},{"topojson-client":"../node_modules/topojson/node_modules/topojson-client/index.js","topojson-server":"../node_modules/topojson/node_modules/topojson-server/index.js","topojson-simplify":"../node_modules/topojson/node_modules/topojson-simplify/index.js"}],"../node_modules/debounce/index.js":[function(require,module,exports) {
/**
...
},{}],"data/Philadelphia.topojson":[function(require,module,exports) {
module.exports = "/Philadelphia.9dad0d68.topojson";
},{}],"data/philly-homicides-2012-present.csv":[function(require,module,exports) {
module.exports = "/philly-homicides-2012-present.171d72f5.csv";
...
Promise.all([d3.json(require('./data/Philadelphia.topojson')), d3.csv(require('./data/philly-homicides-2012-present.csv'))]).then(ready).catch(function (err) {
...
function ready(_ref) {
  ...
  var neighborhoods = topojson.feature(json, json.objects.Philadelphia);
  ...
  // show the map
  svg.selectAll('.neighborhood').data(neighborhoods.features).enter().append('path').attr('class', 'neighborhood').attr('d', path).attr('stroke', 'black').attr('fill', 'none');
  ...
  // Show all murders
  d3.select('#all-murders').on('stepin', function () {
    console.log('step in all-murders');
    svg.selectAll('.murders').data(allData).enter().append('circle').transition().duration(t).attr('class', 'murders').attr('r', 3).attr('transform', function (d) {
      var coords = projection([d.lon, d.lat]);
      return 'translate(' + coords + ')';
    }).attr('opacity', 0.5).attr('fill', '#58508d');

    // return dots to blue on step back
    svg.selectAll('.murders').transition().duration(t).attr('fill', '#58508d');
  });

  // change colors based on race
  d3.select('#race').on('stepin', function () {
    svg.selectAll('.murders').transition().duration(t).attr('fill', function (d) {
  ...
  d3.select('#only-arrest').on('stepin', function () {
    svg.selectAll('.murders').transition().duration(t).attr('r', function (d) {
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","debounce":"../node_modules/debounce/index.js","./data/Philadelphia.topojson":"data/Philadelphia.topojson","./data/philly-homicides-2012-present.csv":"data/philly-homicides-2012-present.csv"}],"../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","01-chart.js"], null)
//# sourceMappingURL=/01-chart.0617d2c7.map